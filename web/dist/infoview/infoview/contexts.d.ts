...
import { InfoviewConfig, LeanDiagnostic, LeanFileProgressProcessingInfo, LeanServerCapabilities } from '@leanprover/infoview-api';
import { EditorConnection } from './editorConnection';
import { ServerVersion } from './serverVersion';
import { DocumentPosition } from './util';
export declare const EditorContext: React.Context<EditorConnection>;
export declare const CapabilityContext: React.Context<ServerCapabilities<LeanServerCapabilities> | undefined>;
