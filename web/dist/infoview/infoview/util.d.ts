...
export declare function count<T>(xs: T[], p: (v: T) => boolean): number;
...
export declare namespace PositionHelpers {
    ...
    function isLessThan(p1: Position, p2: Position): boolean;
}
...
export declare function isAnyTextSelected(): boolean;
export declare function preventClickOnTextSelection(e: React.MouseEvent<HTMLElement, MouseEvent>): boolean;
export declare function withPreventedClickOnTextSelection(f: React.MouseEventHandler<HTMLElement>): React.MouseEventHandler<HTMLElement>;
export declare function preventDoubleClickTextSelection(e: React.MouseEvent<HTMLElement, MouseEvent>): boolean;
