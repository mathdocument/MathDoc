 ...
 * @module
 */
import { HighlightedMsgEmbed } from '@leanprover/infoview-api';
import { InteractiveTextComponentProps } from './interactiveCode';
export declare function InteractiveMessage({ fmt }: InteractiveTextComponentProps<HighlightedMsgEmbed>): import("react/jsx-runtime").JSX.Element;
